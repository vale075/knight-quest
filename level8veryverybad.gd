...
func end():
	...
	$cinema/blacktext/text.text="TU COMBLE MES \n ATTENTES"
	...
	file.close()
	if $mur/base.pv<5:
		$cinema/blacktext/text.text="MAIS RESTE SUR \n CETTE BONNE LIGNEE \n DE VICTOIRE"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		...
		save_game.close()
		get_tree().change_scene("res://level9verybad.tscn")
	else:
		$cinema/blacktext/text.text="JE PENSE QUE \n TOI ET MOI \n POURRONT DOMMINER \n LE MONDE FACILEMENT"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
