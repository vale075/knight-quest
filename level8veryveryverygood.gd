...
func end():
	...
	$cinema/blacktext/text.text="TU DOIT AVOIR \n TES RAISONS MAIS \n SACHE QUE TU \n ME DECOIS"
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
	...
	file.close()
	if $mur/base.pv<5:
		$cinema/blacktext/text.text="TU PEUT ESSAYER \n DE M'AIDER MAIS \n CA NE CHANGERAS \n RIEN... IL EST \n TROP TARD..."
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		_wait(2)
		yield(self,"timer_end")
		$cinema/blacktext/text.text="TOUT CES MORTS... \n TOUT MON ROYAUME \n VA ETRE DETRUIT..."
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		...
		if not lignee=="":
			var save={
				"res://level9veryveryverygood.tscn"  :  "",
		...
		save_game.close()
		get_tree().change_scene("res://level9veryveryverygood.tscn")
	else:
		$cinema/blacktext/text.text="JE NE VAIS \n PAS TE DIRE \n QUOI FAIRE..."
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		_wait(2)
		yield(self,"timer_end")
		$cinema/blacktext/text.text="MAIS SACHE QUE \n TES CHOIX DEFINIRONT \n LE NOMBRE DE MORT"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		...
		for i in save:
			save_game.store_line(i)
		save_game.close()
		get_tree().change_scene("res://level9veryverygood.tscn")
