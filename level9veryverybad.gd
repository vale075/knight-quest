...
func end():
	...
	$cinema/blacktext/text.text="JAMAIS JE N'AURAIS\n CRU QUE VOUS, \n LES HUMAINS, SEREZ \nAUSSI IGNOBLE..."
	...
	file.close()
	if $mur/base.pv<5:
		$cinema/blacktext/text.text="NOUS NE POURRONS \n JAMAIS PARDONNER \n VOS CRIMES"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		...
		save_game.close()
		get_tree().change_scene("res://level10veryverybad.tscn")
	else:
		$cinema/blacktext/text.text="VOTRE VIE \nEST UN FLÉAU"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
