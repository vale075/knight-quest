...
func _ready():
	...
	$sond/musique.play()
	$cinema/blacktext/text.text="MAIS JE CROIS QUE TU \n AVAIS RAISON..."
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
	_wait(2)
	yield(self,"timer_end")
	$cinema/blacktext/text.text="J'éTAIT éBLOUIS PAR \nLA PUISSANCE... MAIS \n J'AVAIS OUBLIER CE \n QUE C'EST QUE \n D'ETRE ROI..."
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
	_wait(2)
	yield(self,"timer_end")
	$cinema/blacktext/text.text="JE DEVAIS AVANT \n TOUT AIDER LES \n AUTRES..."
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
