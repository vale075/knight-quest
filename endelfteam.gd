...
func _ready():
	...
	$cinema/blacktext/text.text="TU AS FAIT \n CONFIANCE A CES \n BARBARES..."
	...
	$cinema/blacktext/text.text="TU VAS \n DEVOIR PAYER"
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
	_wait(2)
	yield(self,"timer_end")
	$cinema/blacktext/text.text="HRUM JE VOIT \n QUE LE ROI ELF \n VEUT SE BATTRE \n CONTRE MOI \n ON DIRAIT"
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
	_wait(2)
	yield(self,"timer_end")
	$cinema/blacktext/text.text="JE VOUS ATTEND \n HAHAHA"
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
...
func end():
	...
	$cinema/blacktext/text.text="NON JE NE \n PEUT PAS MOURRIR!!!"
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
	...
	_wait(5)
	yield(self,"timer_end")
	$cinema/blacktext/text.text="MERCI BEAUCOUP! \n TU NOUS AS \n TOUS SAUVÉ"
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
	_wait(2)
	yield(self,"timer_end")
	$cinema/blacktext/text.text="NOUS TE SERONS \nETERNELEMENT\n RECONNAISSANT"
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
