...
func end():
	...
	$cinema/blacktext/text.text="TU NE NOUS \n AIDE PAS BEAUCOUP... \n TU NE MERITE \n PAS NOS REMERCIMENTS"
	...
	file.close()
	if $mur/base.pv<5:
		$cinema/blacktext/text.text="MAIS TON AIDE \n ME DONNERAS LA \n VICTOIRE"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		...
		$cinema/blacktext/text.text="ET CONTINUE A \n NOUS AIDER!"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		...
		for i in save:
			save_game.store_line(i)
		save_game.close()
		get_tree().change_scene("res://level10verygood.tscn")
