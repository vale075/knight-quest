...
func _ready():
	...
	$cinema/blacktext/text.text="TU EST DEVENU \nTROP PUISSANT"
	...
	$cinema/blacktext/text.text="NOUS ALLONS DEVOIR \n TE TUER"
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
...
func end():
	...
	if over ==2:
		...
		$cinema/blacktext/text.text="... JE SAVAIS QUE \nTU éTAIT TROP \nFORT..."
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
