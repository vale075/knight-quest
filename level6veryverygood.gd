...
func end():
	...
	$cinema/blacktext/text.text="J'AI SENTI DE \n LA MAGIE DANS \n TON ESPRIT"
	...
	$cinema/blacktext/text.text="LES ELFES T'ON \n PARLÉ?"
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
	...
	file.close()
	if $mur/base.pv<5:
		$cinema/blacktext/text.text="J'AI L'IMPRESSION \n QUE TU LES \n CROIS..."
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		_wait(2)
		yield(self,"timer_end")
		$cinema/blacktext/text.text="SACHE QU'ILS \n TE MENTENT! ILS \n MENACENT DES \n MILIERS DE VIE..."
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		_wait(2)
		yield(self,"timer_end")
		$cinema/blacktext/text.text="J'AI CONFIANCE \n EN TOI! JE \n SAIT QUE TU \n SAURAS TROUVER \n QU'ILS MENTENT"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		...
		if not lignee=="":
			var save={
				"res://level7veryverygood"  :  "",
				pvextract+str($mur/base.pv)  :  "",
				lignee : ""
			}
		else:
			var save={
				"res://level7veryverygood.tscn"  :  "",
				pvextract+str($mur/base.pv)  :  ""
			}
		for i in save:
			save_game.store_line(i)
		save_game.close()
		get_tree().change_scene("res://level7veryverygood.tscn")
	else:
		$cinema/blacktext/text.text="JE VOIT QUE \n TU DOUTE..."
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		_wait(2)
		yield(self,"timer_end")
		$cinema/blacktext/text.text="CROIT MOI... \n SI JE SUIS \n MAUVAIS JE NE \n T'AURAIS PAS \n INVOQUÉ"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		...
		for i in save:
			save_game.store_line(i)
		save_game.close()
		get_tree().change_scene("res://level7verygood.tscn")
