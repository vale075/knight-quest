...
func end():
	...
	$cinema/blacktext/text.text="TU MERITE AUTANT \n LA MORT QUE \n TES SEMBLABLES"
	...
	file.close()
	if $mur/base.pv<5:
		$cinema/blacktext/text.text="TON IMPLICATION \n N'EST QU'UN \n DETAIL MAIS IL \n CONTRIBUE A LA \n SOUFRANCE DE \n MON PEUPLE"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		...
		save_game.close()
		get_tree().change_scene("res://level10verybad.tscn")
	else:
		$cinema/blacktext/text.text="LES HUMAINS NE \n SONT QUE BETE \n SANGUINAIRE"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
