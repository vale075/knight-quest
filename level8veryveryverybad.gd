...
func end():
	...
	$cinema/blacktext/text.text="J'AI CREE L'ARME \nULTIME!!!"
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
	...
	file.close()
	if $mur/base.pv<5:
		$cinema/blacktext/text.text="JE DOIT T'AVOUER \n QUE LE PEUPLE \n DE MON ROYAUME \n EST INEXISTANT"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		_wait(2)
		yield(self,"timer_end")
		$cinema/blacktext/text.text="JE NE COMBAT \n QUE POUR LE \n SANG!"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		_wait(2)
		yield(self,"timer_end")
		$cinema/blacktext/text.text="MAIS TU T'EN \n FICHE! TOI AUSSI \n TU VIE POUR \n LE SANG!"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		...
		save_game.close()
		get_tree().change_scene("res://level9veryverybad.tscn")
	else:
		$cinema/blacktext/text.text="MAIS N'OUBLIE PAS \n QUE JE SUIS \n ET RESTERAS \n TON MAITRE!"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		...
		if not lignee=="":
			var save={
				"res://level9veryveryverybad.tscn"  :  "",
				pvextract+str($mur/base.pv)  :  "",
				lignee : ""
			}
		else:
		...
		for i in save:
			save_game.store_line(i)
		save_game.close()
		get_tree().change_scene("res://level9veryveryverybad.tscn")
