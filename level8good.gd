...
func end():
	...
	$cinema/blacktext/text.text="L'INDECISION VAUDRAS \n LA MORT DE \n TOUS..."
	...
	$cinema/blacktext/text.text="TU LE SAIT?"
	$cinema/blacktext.visible=true
	yield(self,"ok")
	$cinema/blacktext/text.text=""
	$cinema/blacktext.visible=false
	...
	file.close()
	if $mur/base.pv<5:
		$cinema/blacktext/text.text="J'ESPERE VRAIMENT QUE \n TU NE SOUHAITE \n PAS VOIT UN \n BAIN DE SANG"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		...
		$cinema/blacktext/text.text="J'AI EU RAISON \n D'AVOIR PEUR DE \n TOI"
		$cinema/blacktext.visible=true
		yield(self,"ok")
		$cinema/blacktext/text.text=""
		$cinema/blacktext.visible=false
		...
		for i in save:
			save_game.store_line(i)
		save_game.close()
		get_tree().change_scene("res://level9normal.tscn")
